package com.example.server.theater.api;

import com.example.server.theater.dto.FindAllDTO;
import com.example.server.theater.dto.TheaterDTO;
import com.example.server.theater.entity.Theater;
import com.example.server.theater.service.TheaterService;
...
public class TheaterController {
    ...
    // 지점 등록 요청
    @PostMapping()
    public ResponseEntity<?> create(@RequestBody Theater newTheater ) { // Post 에는 주소가 불가능하므로 pathVariable 삭제
        newTheater.setTheaterID(UUID.randomUUID().toString()); // RandomUUID 생성
